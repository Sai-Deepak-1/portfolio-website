...
} from "@/components/layout/projects/project-showcase-list";
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="h-8 w-8">
            <CgArrowTopRightO className="rotate-45 text-accent transition-transform duration-300 group-hover:rotate-0 group-hover:scale-[1.1]" />
          </div>
        </Link>
      </div>
    </section>
