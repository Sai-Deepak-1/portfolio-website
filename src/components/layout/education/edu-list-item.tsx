...
export interface EduListIconProps {
  iconRef: RefObject<HTMLElement>;
}

function ShowCaseLiIcon(props: EduListIconProps) {
...
export interface EduListItemProps {
  title: string;
  organisation: {
    name: string;
    href: string;
...
export default function EduListItem(
  props: EduListItemProps,
) {
